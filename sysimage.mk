...
RELBUILDROOT := $(shell $(PYTHON) $(call python_cygpath,$(JULIAHOME)/contrib/relative_path.py) "$(call python_cygpath,$(JULIAHOME)/base)" "$(call python_cygpath,$(BUILDROOT)/base)")
